...
--
-- El trigger anterior seguía intentando escribir en la tabla antigua,
-- provocando que UPDATE/DELETE/INSERT de propiedades fallaran antes de
-- completar la operación. Esto afectaba directamente las ediciones desde
-- el panel y la sincronización del catálogo público.
