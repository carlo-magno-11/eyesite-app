...
const s=StyleSheet.create({page:{flex:1,backgroundColor:"#0E0E0E",padding:20,paddingTop:55},back:{color:EYESITE_THEME.colors.gold,fontWeight:"800",marginBottom:18},title:{color:EYESITE_THEME.colors.text,fontSize:28,fontWeight:"900",marginBottom:20},card:{backgroundColor:EYESITE_THEME.colors.surface,borderWidth:1,borderColor:EYESITE_THEME.colors.border,borderRadius:12,padding:16,marginBottom:12},heading:{color:"#C9A84C",fontWeight:"900"},email:{color:"#FFF",marginTop:8},info:{color:EYESITE_THEME.colors.muted,fontSize:11,lineHeight:17,marginTop:8},row:{backgroundColor:"#171717",borderWidth:1,borderColor:"#2A2A2A",borderRadius:10,padding:16,marginBottom:9,flexDirection:"row",justifyContent:"space-between"},rowText:{color:"#FFF",fontWeight:"700"},arrow:{color:"#C9A84C",fontSize:24},logout:{borderWidth:1,borderColor:"#C9A84C",borderRadius:8,padding:15,alignItems:"center",marginTop:12},logoutText:{color:"#C9A84C",fontWeight:"900"}
});