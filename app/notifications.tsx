    ...
    <ScreenContainer edges={["top", "left", "right"]} containerClassName="bg-background">
      <View style={[s.h, { paddingHorizontal: horizontalPadding, maxWidth: contentMaxWidth, width: "100%", alignSelf: "center" }]}>
        ...
        <Pressable onPress={() => router.push("/notification-settings" as never)} hitSlop={10}>
          <Ionicons name="settings-outline" size={24} color={EYESITE_THEME.colors.gold} />
        </Pressable>
      </View>
...
const s = StyleSheet.create({
  ...
  t:{color:EYESITE_THEME.colors.text,fontSize:20,fontWeight:"800",letterSpacing:1},
  sub:{color:EYESITE_THEME.colors.muted,fontSize:12,marginTop:4},
  tabs:{flexDirection:"row",paddingHorizontal:16,paddingTop:14,gap:8},
  tab:{flex:1,paddingVertical:11,borderRadius:10,backgroundColor:EYESITE_THEME.colors.surface,alignItems:"center",borderWidth:1,borderColor:EYESITE_THEME.colors.border},
  tabActive:{borderColor:"#C9A84C",backgroundColor:EYESITE_THEME.colors.surfaceSoft},
  tabText:{color:EYESITE_THEME.colors.muted,fontSize:12,fontWeight:"700"},
  tabTextActive:{color:EYESITE_THEME.colors.gold},
  ...
  dot:{width:8,height:8,borderRadius:4,backgroundColor:EYESITE_THEME.colors.gold},
  ct:{color:EYESITE_THEME.colors.text,fontSize:16,fontWeight:"700",flex:1},
  ty:{color:"#C9A84C",fontSize:10,fontWeight:"800",marginTop:6},
  m:{color:EYESITE_THEME.colors.textSoft,fontSize:14,lineHeight:21,marginTop:8},
  d:{color:EYESITE_THEME.colors.mutedDark,fontSize:10,marginTop:10},
