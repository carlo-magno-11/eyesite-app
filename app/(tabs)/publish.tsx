...
mapInstruction: {
  ...
  locationHint: { color: '#8E8E8E', fontSize: 12, lineHeight: 17, marginBottom: 10 },
  locationBtn: { backgroundColor: '#C9A84C', borderRadius: 9, paddingVertical: 13, alignItems: 'center' },
  locationBtnText: { color: '#0D0D0D', fontSize: 12, fontWeight: '800', letterSpacing: 0.8 },
  coordinatesText: { color: '#7E7E7E', fontSize: 10, marginTop: 7, textAlign: 'center' },
  successContainer: {
    flex: 1,
    justifyContent: 'center',
    alignItems: 'center',
