  ...
  const fetchProperties = useCallback(async () => {
    try {
      ...
      if (err) {
        ...
        // Nunca sustituir datos reales por propiedades de demostración.
        // Esto evita que el mapa/listados muestren propiedades que no existen en Supabase.
        setProperties([]);
        return;
      }
      ...
      setError(msg);
      // No mostrar datos simulados ante un error de red/Supabase.
      setProperties([]);
    } finally {
      setLoading(false);
    }
